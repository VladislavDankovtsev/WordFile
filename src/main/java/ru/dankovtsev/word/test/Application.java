package ru.dankovtsev.word.test;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CTP ctpFooterModel = createFooterModel("Или нет");
            ...
            File file = new File("kvi.jpg");
            BufferedImage img = ImageIO.read(file);
            ByteArrayOutputStream os = new ByteArrayOutputStream();
            ImageIO.write(img, "jpg", os);
            InputStream imgFile = new ByteArrayInputStream(os.toByteArray());;
            paragraphConfig.addPicture(imgFile, XWPFDocument.PICTURE_TYPE_PNG, "out.png", Units.toEMU(500), Units.toEMU(500));

            InputStream imgFile2 = new ByteArrayInputStream(os.toByteArray());;
            paragraphConfig.addPicture(imgFile2, XWPFDocument.PICTURE_TYPE_PNG, "out.png", Units.toEMU(500), Units.toEMU(500));
